...
#### "nimble_code3" is model 3 in paper. Change to what you want in nimble_models.R.

model <- nimbleModel(nimble_code3, constants = constants, data = data, inits = inits)

...
#### "nimble_code5" is model 5 in paper. Change to what you want in nimble_models.R.

model <- nimbleModel(nimble_code5, constants = constants, data = data, inits = inits)

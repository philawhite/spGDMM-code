...
#### "nimble_code6" is model 6 in paper. Change to what you want in nimble_models.R.

model <- nimbleModel(nimble_code6, constants = constants, data = data, inits = inits)

...
#### "nimble_code9" is model 9 in paper. Change to what you want in nimble_models.R.

model <- nimbleModel(nimble_code9, constants = constants, data = data, inits = inits)
